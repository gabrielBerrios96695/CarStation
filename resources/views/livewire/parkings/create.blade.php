...
<div class="container">
    <div class="d-flex justify-content-between align-items-center my-4">
        <h1 class="h3">Crear Nuevo Estacionamiento</h1>
            ...
            <form action="{{ route('parkings.store') }}" method="POST">
                ...
                <div class="form-group row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="latitude" name="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude', '-17.4136') }}" readonly>
                        @error('latitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="longitude" name="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude', '-66.1652') }}" readonly>
                        @error('longitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Guardar Estacionamiento
                </button>
            </form>
        </div>
    </div>
